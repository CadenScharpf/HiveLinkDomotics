...
INSERT INTO user (email, telephone, first_name, last_name, role, created_at, modified_at)
VALUES
  ('user1@example.com', '123-456-7890', 'John', 'Doe', 1, NOW(), NOW()),
  ('user2@example.com', '987-654-3210', 'Jane', 'Smith', 2, NOW(), NOW());
