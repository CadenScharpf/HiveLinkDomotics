...
function Landing(props: IRouteProps) {
  ...
  return (
    //tod0:: extract nav and sidebar into master layout component
    <>
      ...
      {location.pathname === props.path ? (
        <Box sx={{ width: "100%", height: "100%" }}>
          ...
          >
            ...
            >
              ...
              <video
                ...
                style={{ height: "100%" }}
              >
                <source src="/landing_clip.mp4" type="video/mp4" />
              </video>
            </Box>
            <Box
              sx={{
            ...
            >
              ...
              >
                ...
                {config.section1.links.slice(1).map((link: any) => {
                  return (
                    <React.Fragment
                      key={"landingS1LinkFragmentTo::" + link.path}
                    >
                      <HiveIcon
          ...
          <Box
            component={"section"}
            sx={{ height: "100vh", width: "100%", display: "none" }}
          >
